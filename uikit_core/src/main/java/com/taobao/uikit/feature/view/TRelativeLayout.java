...
public class TRelativeLayout extends RelativeLayout implements ViewHelper, ViewGroupHelper, IFeatureList<RelativeLayout> {
	...
	private FeatureList<RelativeLayout> mFeatureList = new FeatureList<RelativeLayout>(this);
	...
	@Override
	public boolean addFeature(AbsFeature<? super RelativeLayout> feature) {
		return mFeatureList.addFeature(feature);
	}

	@Override
	public AbsFeature<? super RelativeLayout> findFeature(
			Class<? extends AbsFeature<? super RelativeLayout>> clazz) {
		return mFeatureList.findFeature(clazz);
	}

	@Override
	public boolean removeFeature(Class<? extends AbsFeature<? super RelativeLayout>> clazz) {
