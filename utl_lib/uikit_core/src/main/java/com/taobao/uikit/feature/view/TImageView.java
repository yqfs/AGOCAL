...
/**
 * TImageView : UIKit's custom ImageView
 * 
 * @author jiajing
 * 
 */
public class TImageView extends ImageView implements ViewHelper,
		IFeatureList<ImageView> {

	private FeatureList<ImageView> mFeatureList = new FeatureList<ImageView>(
			this);
	...
	@Override
	public boolean addFeature(AbsFeature<? super ImageView> feature) {	
	...
	@Override
	public boolean removeFeature(Class<? extends AbsFeature<? super ImageView>> clazz) {
